...
function servePublicFiles(siteApp) {
    ...
    // Local Portal bundle for development overrides
    siteApp.get('/public/portal.local.js', createPublicFileMiddleware('static', 'public/portal.local.js', 'application/javascript', config.get('caching:publicAssets:maxAge')));
