    ...
    return (
        <Dialog {...props}>
            ...
            <DialogContent className='max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8'>
                ...
                <a className='hover:border-muted-foreground/40 flex flex-col items-stretch overflow-hidden rounded-md border transition-all' href={postURL} rel="noopener noreferrer" target='_blank'>
                    {featureImageURL &&
                    ...
                    {emailOnly ?
                        ...
                        <>
                            <div className='flex items-center gap-2'>
                                <a aria-label='Share on X' className='hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4' href={`https://twitter.com/intent/tweet?text=${encodedPostTitle}%0A${encodedPostURL}`} rel="noopener noreferrer" target='_blank'>
                                ...
                                <a aria-label='Share on Threads' className='hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4' href={`https://threads.net/intent/post?text=${encodedPostURLTitle}`} rel="noopener noreferrer" target='_blank'>
                                ...
                                <a aria-label='Share on Facebook' className='hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4' href={`https://www.facebook.com/sharer/sharer.php?u=${encodedPostURL}`} rel="noopener noreferrer" target='_blank'>
                                ...
                                <a aria-label='Share on LinkedIn' className='hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4' href={`https://www.linkedin.com/shareArticle?mini=true&title=${encodedPostTitle}&url=${encodedPostURL}`} rel="noopener noreferrer" target='_blank'>
